...
/**
 * This class implements the NONDL_A weighting model.
 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NONDL_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NONDL_A";
	...
	/** 
	 * Constructs an instance of NONDL_A
	 * @param _b
	 */
	public NONDL_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NONDL_A"
