...
public class TF_IDF2 extends WeightingModel {
	...
	/** 
	 * Constructs an instance of TF_IDF2
	 * @param _b
	 */
	...
	/**
	 * Returns the name of the model, in this case "TF_IDF2"
	...
	/**
	 * Uses TF_IDF2 to compute a weight for a term in a document.
	 ...
	 * @return the score assigned by the weighting model TF_IDF2.
	 */
