 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class DHGB1 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "DHGB1";
	...
	/** 
	 * Constructs an instance of DHGB1
	 * @param _b
	 */
	public DHGB1(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "DHGB1"
