 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NOIDF extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NOIDF";
	...
	/** 
	 * Constructs an instance of NOIDF
	 * @param _b
	 */
	public NOIDF(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NOIDF"
