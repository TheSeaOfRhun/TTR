 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NOLOGTF extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NOLOGTF";
	...
	/** 
	 * Constructs an instance of NOLOGTF
	 * @param _b
	 */
	public NOLOGTF(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NOLOGTF"
