 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NOIDF_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NOIDF_A";
	...
	/** 
	 * Constructs an instance of NOIDF_A
	 * @param _b
	 */
	public NOIDF_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NOIDF_A"
	...
	/**
	 * Uses NOIDF_A to compute a weight for a term in a document.
