 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class ONEIDF_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "ONEIDF_A";
	...
	/** 
	 * Constructs an instance of ONEIDF_A
	 * @param _b
	 */
	public ONEIDF_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "ONEIDF_A"
	...
	public final double score(double tf, double docLength) {
	    ...
	    double IDF1 = WeightingModelLibrary.log(numberOfDocuments/documentFrequency + 1.0f);
	    double NDL  = docLength/averageDocumentLength;
	    return keyFrequency * TF1 * IDF1 / NDL;
	}
	/**
