 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF3 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF3";
	...
	/** 
	 * Constructs an instance of TFIDF3
	 * @param _b
	 */
	public TFIDF3(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF3"
