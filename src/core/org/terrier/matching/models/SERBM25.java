 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class SERBM25 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "SERBM25";
	...
	/** 
	 * Constructs an instance of SERBM25
	 * @param _b
	 */
	public SERBM25(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "SERBM25"
	...
	public final double score(double tf, double docLength) {
	    ...
	    double K1 = 2.0, K3 = 2.0, b = 0.75;
	    double tfq = (K3 + 1.0) * keyFrequency / (K3 + keyFrequency);
