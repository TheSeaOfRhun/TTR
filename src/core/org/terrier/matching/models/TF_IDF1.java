 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TF_IDF1 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TF_IDF1";
	...
	/** 
	 * Constructs an instance of TF_IDF1
	 * @param _b
	 */
	public TF_IDF1(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TF_IDF1"
	...
	/**
	 * Uses TF_IDF1 to compute a weight for a term in a document.
	...
	public final double score(double tf, double docLength) {
		...
		double idf = numberOfDocuments/documentFrequency+1;
	 ...
	 * @return the score assigned by the weighting model TF_IDF1.
	 */
