 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class SERSIMPLE1 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "SERSIMPLE1";
	...
	/** 
	 * Constructs an instance of SERSIMPLE1
	 * @param _b
	 */
	public SERSIMPLE1(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "SERSIMPLE1"
	...
	public final double score(double tf, double docLength) {
	    ...
	    double ndl1 = Idf.log(docLength);
	    double K1 = 2.0, b = 0.75;
	    double wt = (K1 + 1.0) * tf * idf / (K1 * (1.0 - b + b * ndl1) + tf);
