 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class LOGNDL_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "LOGNDL_A";
	...
	/** 
	 * Constructs an instance of LOGNDL_A
	 * @param _b
	 */
	public LOGNDL_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "LOGNDL_A"
	...
	public final double score(double tf, double docLength) {
	    double TF1  = WeightingModelLibrary.log(tf);
	    double IDF  = WeightingModelLibrary.log(numberOfDocuments/documentFrequency);
	    double NDL2 = WeightingModelLibrary.log(docLength/averageDocumentLength);
	    return keyFrequency * TF1 * IDF / NDL2;
	}
	/**
