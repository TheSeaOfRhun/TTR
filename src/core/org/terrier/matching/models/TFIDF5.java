 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF5 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF5";
	...
	/** 
	 * Constructs an instance of TFIDF5
	 * @param _b
	 */
	public TFIDF5(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF5"
