 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF_A";
	...
	/** 
	 * Constructs an instance of TFIDF_A
	 * @param _b
	 */
	public TFIDF_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF_A"
	...
	public final double score(double tf, double docLength) {
	    ...
	    return keyFrequency * TF1 * IDF / NDL;
	}
	/**
