 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NOLOGTF_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NOLOGTF_A";
	...
	/** 
	 * Constructs an instance of NOLOGTF_A
	 * @param _b
	 */
	public NOLOGTF_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NOLOGTF_A"
	...
	public final double score(double tf, double docLength) {
	    ...
	    return keyFrequency * TF * IDF / NDL;
	}
	/**
