 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF7 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF7";
	...
	/** 
	 * Constructs an instance of TFIDF7
	 * @param _b
	 */
	public TFIDF7(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF7"
	...
	public final double score(double tf, double docLength) {
	    ...
	    double wt = (K1 + 1.0) * tf / (K1 * (1.0 - b + b * ndl) + tf);
