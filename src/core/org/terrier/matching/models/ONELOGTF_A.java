 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class ONELOGTF_A extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "ONELOGTF_A";
	...
	/** 
	 * Constructs an instance of ONELOGTF_A
	 * @param _b
	 */
	public ONELOGTF_A(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "ONELOGTF_A"
	...
	public final double score(double tf, double docLength) {
	    ...
	    return keyFrequency * (1.0f + TF1) * IDF / NDL;
	}
	/**
