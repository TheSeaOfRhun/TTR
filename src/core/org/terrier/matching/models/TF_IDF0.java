 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TF_IDF0 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TF_IDF0";
	...
	/** 
	 * Constructs an instance of TF_IDF0
	 * @param _b
	 */
	public TF_IDF0(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TF_IDF0"
	...
	/**
	 * Uses TF_IDF0 to compute a weight for a term in a document.
	 ...
	 * @return the score assigned by the weighting model TF_IDF0.
	 */
