 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class SERSIMPLE2 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "SERSIMPLE2";
	...
	/** 
	 * Constructs an instance of SERSIMPLE2
	 * @param _b
	 */
	public SERSIMPLE2(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "SERSIMPLE2"
	...
	public final double score(double tf, double docLength) {
	    ...
	    double ndl2 = Idf.log(docLength/averageDocumentLength);
	    double K1 = 2.0, b = 0.75;
	    double wt = (K1 + 1.0) * tf * idf / (K1 * (1.0 - b + b * ndl2) + tf);
