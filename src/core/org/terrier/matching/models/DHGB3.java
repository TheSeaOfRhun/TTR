 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class DHGB3 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "DHGB3";
	...
	/** 
	 * Constructs an instance of DHGB3
	 * @param _b
	 */
	public DHGB3(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "DHGB3"
