 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF2 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF2";
	...
	/** 
	 * Constructs an instance of TFIDF2
	 * @param _b
	 */
	public TFIDF2(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF2"
