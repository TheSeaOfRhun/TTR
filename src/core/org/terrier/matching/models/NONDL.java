 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class NONDL extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "NONDL";
	...
	/** 
	 * Constructs an instance of NONDL
	 * @param _b
	 */
	public NONDL(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "NONDL"
