 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF8 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF8";
	...
	/** 
	 * Constructs an instance of TFIDF8
	 * @param _b
	 */
	public TFIDF8(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF8"
