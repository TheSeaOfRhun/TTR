 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF6 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF6";
	...
	/** 
	 * Constructs an instance of TFIDF6
	 * @param _b
	 */
	public TFIDF6(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF6"
