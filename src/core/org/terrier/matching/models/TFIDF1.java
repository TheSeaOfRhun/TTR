 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF1 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF1";
	...
	/** 
	 * Constructs an instance of TFIDF1
	 * @param _b
	 */
	public TFIDF1(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF1"
