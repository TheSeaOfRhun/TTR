 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class LOGNDL extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "LOGNDL";
	...
	/** 
	 * Constructs an instance of LOGNDL
	 * @param _b
	 */
	public LOGNDL(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "LOGNDL"
