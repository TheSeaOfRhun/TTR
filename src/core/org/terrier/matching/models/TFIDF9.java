 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF9 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF9";
	...
	/** 
	 * Constructs an instance of TFIDF9
	 * @param _b
	 */
	public TFIDF9(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF9"
