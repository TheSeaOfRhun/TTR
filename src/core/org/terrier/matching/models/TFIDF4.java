 ...
 * @author Ben He, Gianni Amati, Vassilis Plachouras
  */
public class TFIDF4 extends WeightingModel {
	
	private static final long serialVersionUID = 1L;

	/** model name */
	private static final String name = "TFIDF4";
	...
	/** 
	 * Constructs an instance of TFIDF4
	 * @param _b
	 */
	public TFIDF4(double _b) {
		this();
		this.b = _b;
	}

	/**
	 * Returns the name of the model, in this case "TFIDF4"
	...
	public final double score(double tf, double docLength) {
	    double idf3 = numberOfDocuments/documentFrequency;
	    double wt = tf * idf3;
